    ...
    $.Zebra_DatePicker = function(element, options) {
        ...
        var generate_daypicker = function() {
            ...
            for (var i = 0; i < 7; i++)
                ...
                html += '<th>' + ($.isArray(plugin.settings.days_abbr) && undefined !== plugin.settings.days_abbr[(plugin.settings.first_day_of_week + i) % 7] ? plugin.settings.days_abbr[(plugin.settings.first_day_of_week + i) % 7] : plugin.settings.days[(plugin.settings.first_day_of_week + i) % 7].substr(0, 3)) + '</th>';
